...
public class Chromatic12NotePickerAdapterBends extends RecyclerView.Adapter<Chromatic12NotePickerAdapterBends.NoteViewHolder> {
    ...
    public Chromatic12NotePickerAdapterBends(Context context, NotePickerAdapterListener listener, DbNote selectedNote) {
    ...
    public void onBindViewHolder(final NoteViewHolder holder, int position) {
        ...
        // set hole text
        CustomizationUtils.styleChromatic12NoteText(holder.upperNoteButton, note, 0.5f, blowSign, blowStyle, buttonStyle, CustomizationUtils.createNotePickerTextColor(context, blowTextColor));
        ...
        CustomizationUtils.styleChromatic12NoteText(holder.lowerNoteButton, note, -0.5f, drawSign, drawStyle, buttonStyle, CustomizationUtils.createNotePickerTextColor(context, drawTextColor));
