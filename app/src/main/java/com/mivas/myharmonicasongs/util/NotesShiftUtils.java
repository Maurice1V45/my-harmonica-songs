...
public class NotesShiftUtils {
    ...
    public static boolean isIncreasePossible(DbNote dbNote, int harpType) {
    ...
    public static void increase(DbNote dbNote, int harpType) {
        int hole = dbNote.getHole();
        boolean blow = dbNote.isBlow();
        float bend = dbNote.getBend();
        if (harpType == 0) {
    ...
    public static boolean isDecreasePossible(DbNote dbNote, int harpType) {
        int hole = dbNote.getHole();
        boolean blow = dbNote.isBlow();
        float bend = dbNote.getBend();
        if (harpType == 0) {
    ...
    public static void decrease(DbNote dbNote, int harpType) {
        int hole = dbNote.getHole();
        boolean blow = dbNote.isBlow();
        float bend = dbNote.getBend();
        if (harpType == 0) {
